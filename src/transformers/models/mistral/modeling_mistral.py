...
from ...integrations.deepspeed import deepspeed_ring_attention, support_deepspeed_ulysses
...
>>>>>>> 794fde7b1c3d041519fc28ea3e1461b0cfcad4e7
            else:
    ...
    def forward(
        ...
        **kwargs,
        ...
        if hasattr(self, "sp_size") and self.sp_size > 1:
            scaled_dot_product_attention = deepspeed_ring_attention(
